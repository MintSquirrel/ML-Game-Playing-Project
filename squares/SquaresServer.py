...
from squares.keras.NNet import NNetWrapper
from squares.SquaresPlayers import GreedyRandomPlayer
...
if __name__ == '__main__':
    ...
    n1.load_checkpoint(os.path.join('..', 'pretrained_models', 'squares', 'keras', '3x3'), 'best.pth.tar')
